...
TEXT_OUTPUT=$(maim -g 144x61+2231+487 | convert +dither -colors 3 -colors 2 -colorspace gray -normalize -scale 300% -channel RGB -negate - - | tesseract --dpi 300 - - | perl -pe 's/\n/ /g' | awk '{print $1+$2-1}')
